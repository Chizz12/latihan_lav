    ...
    <div class="card shadow mb-4 w-75">
        ...
        <div class="card-body">
            <form action="{{ route('posts.edit.update', $post->id) }}" method="post">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Judul</label>
                            <input type="text" name="title" value="{{$post->title}}" class="form-control form-control-user" placeholder="Belajar Lavarel Dasar">
                        </div>
                    </div>
                ...
                <div class="row">
                    <textarea name="body" rows="5" class="summernot form-control">{{$post->body}}</textarea>
                </div>
